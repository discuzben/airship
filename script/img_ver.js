...
// 拼图初始化存在的left位置
    var left_Num = -X + 10;
// 图形滑块验证码 DOM 生成
    var html = '<div style="position:relative;padding:16px 16px 28px;border:1px solid #ddd;background:#fff;border-radius:16px;">';
    ...
    html += '<div style="border:1px solid #c3c3c3;border-radius:24px;background:#152444;box-shadow:0 1px 1px rgba(12,10,10,0.2) inset;">';
    html += '<p style="font-size:12px;color: #ffffff;line-height:28px;margin:0;text-align:right;padding-right:22px;">按住左边滑块，拖动完成上方拼图</p>';
    html += '</div>';
